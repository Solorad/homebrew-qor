class Qor < Formula
  ...
  url "https://github.com/Qordobacode/Cli-v2/archive/v0.6.4.tar.gz"
  sha256 "ead98aea37d4d3171d241f409f645ffaa747049318f48b7c94c476d493467e9e"
  ...
  def install
    ...
    ldflags = %W[
        ...
        -X github.com/Qordobacode/Cli-v2/version.Version=0.6.4
    ]
    src.cd do
